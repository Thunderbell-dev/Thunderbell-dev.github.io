...
# Paths
affiliates_path = "../pages/affiliates/family-text/"
html_path = "../pages/affiliates/family-html/"
json_path = "../pages/affiliates/affiliates-list.json"
template_html_path = "../templates/affiliates-family.html"

# Ensure the output directory exists
os.makedirs(html_path, exist_ok=True)

# Get all Markdown file names
md_files = [f for f in os.listdir(affiliates_path) if f.endswith(".md")]
